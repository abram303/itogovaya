...
#main класс кода отвечающий за все процессы
class Main(tk.Frame):
...
class DB:
    def __init__(self):
        #создание таблицы в базе данных если не создана
